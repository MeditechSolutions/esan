odoo.define('hsp_tree_edit.ListController', function (require) {
    ...
    ListController.include({
        renderButtons: function ($node) {
            ...
            this.hsp_start = 0;
            this.hsp_editable_btn = $('<button type="button" style="color: #6c757d;" class="btn btn-secondary fa fa-pencil hsp_editable_btn" title="Editar" style="position: relative;"></button>')
